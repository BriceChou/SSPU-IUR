...
public class TimeConfig {
	...
	public static int getIntervalDays(Date date, Date otherDate) {
		int num = -1;
		Date dateTmp = TimeConfig.StringToDate(TimeConfig.getDate(date),
				DateStyle.YYYY_MM_DD);
		Date otherDateTmp = TimeConfig.StringToDate(
				TimeConfig.getDate(otherDate), DateStyle.YYYY_MM_DD);
