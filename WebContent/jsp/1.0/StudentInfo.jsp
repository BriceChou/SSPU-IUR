	...
	<thead>
    	...
    	<tr id=ligh>
            ...
            <br></br>
    		  ...
    		  <s:iterator value="studentInfo" status="status">
    	<tr class="<s:if test="#status.even">even</s:if><s:else>odd</s:else>">
            ...
            <td><s:property value="StudentFormerName" />&nbsp;&nbsp;</td>      
            <td><s:property value="StudentNationality" />&nbsp;&nbsp;</td>      
            <td><s:property value="StudentParty" />&nbsp;&nbsp;</td>      
        </tr>
        <tr><br></br></tr></s:iterator>
