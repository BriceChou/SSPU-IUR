...
<section class="widget">
    ...
    <table >
        ...
        <table>
          ...
          <tr class="<s:if test="#status.even">even</s:if><s:else>odd</s:else>">
          <td><s:property value="JobsName" />&nbsp;&nbsp;</td>
         <td><s:property value="JobsSite" />&nbsp;&nbsp;</td>
					 <td><s:property value="JobsWorkhours" />&nbsp;&nbsp;</td>
						 <td><s:property value="JobsDegreeRequirement" />&nbsp;&nbsp;</td>
					 <td><s:property value="JobsDescriptionOne" />&nbsp;&nbsp;</td>
					 <td><s:property value="JobsDetailOne" />&nbsp;&nbsp;</td>
